      ...
      <main className="wrap dashboard client-wrap">
        ...
        <div className="card card-pad" style={{ marginBottom: 16 }}>
          ...
          <p className="dash-sub" style={{ marginBottom: 0 }}>
            <b>⚠️ 유효가 된 리드는 상태를 직접 바꿀 수 없습니다.</b> 정산(과금) 기준이 되는 상태라서,
            실수로 되돌리면 근거 없는 환급이 생기기 때문에 막아두었습니다. 유효로 확정된 리드의 상태를
            바꾸고 싶다면 반드시 아래 <b>3번 AS 요청</b>으로 담당 마케터에게 요청해 주세요 — 마케터가
            인정하면 무효로, 거부하면 유효로 그대로 확정됩니다.
          </p>
        </div>
