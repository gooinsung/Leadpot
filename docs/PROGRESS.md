...
> ### 🔴 2026-08-09 (밤) — **[장애] 문자 발송 전체 불가: 솔라피 IP 허용목록에 Railway IP 없음**
>
...
> **⚠️ 첨부만이 아니라 발송 자체가 같은 키를 쓴다 → 2026-08-09 Railway 컷오버 이후 문자가 전부 실패했을 것.**
...
>
> **해야 할 일**: ① Railway Pro 업그레이드 ② Static IPs 켜고 3개 확보 ③ 솔라피에 3개 등록
> ④ VM 종료 후 옛 IP 제거. **문자가 지금 죽어 있으므로, 급하면 ①~③ 전에 솔라피 IP 제한을 잠시 해제**해
> 서비스부터 살리고 나중에 고정 IP 로 다시 잠그는 순서도 가능.
