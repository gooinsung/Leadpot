...
> ### 🔄 2026-08-06 (wincube PC) — 자동 승인 기간 · 광고주 삭제 500 수정 · 계정 상한 해제
>
> **브랜치 `feature/auto-approve` (`752d4c9`) — 아직 `main` 미병합 · 미배포**
> 백엔드 테스트 **194개 통과**(신규 10) · 프론트 타입체크·빌드 통과 · **Flyway V27 까지 → 다음은 V28**
> 담긴 것: ① 자동 승인 기간 ② 광고주 계정 상한 해제 ③ 광고주 삭제 500 수정
>
> #### 무엇을 만들었나
