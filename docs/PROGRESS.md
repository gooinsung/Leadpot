...
> ### ⏸ 2026-08-06 세션 마감 (wincube PC) — **다음 세션은 여기서 시작**
>
...
> 4. 🔴 **광고주 수신 동의 체크박스** — MESSAGING-PLAN §9 에 새 절로 정리. **문자(SMS)는 이미 동작 중이라
>    알림톡보다 먼저 해당된다.** 마케터가 남의 번호를 대신 넣는데 동의 근거가 없고, 발신 채널이 우리
>    명의 하나라 신고 시 전 고객 알림톡이 멈춘다. 붙일 자리는 [FormEditPage.tsx:786](../frontend/src/pages/FormEditPage.tsx#L786).
>
